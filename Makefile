...
am__aclocal_m4_deps = $(top_srcdir)/m4/aclocal_fc.m4 \
...
CONFIG_CLEAN_FILES = doxygen/Doxyfile utils/subfiling_vfd/h5fuse
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/bin/compile \
	...
	$(top_srcdir)/doxygen/Doxyfile.in \
	$(top_srcdir)/utils/subfiling_vfd/h5fuse.in COPYING README.md
...
ACLOCAL = ${SHELL} '/home/fred/CLionProjects/HDF5_parallel_LZ4/bin/missing' aclocal-1.16
...
AR_FLAGS = cr
ASSERTS = no
AUTOCONF = ${SHELL} '/home/fred/CLionProjects/HDF5_parallel_LZ4/bin/missing' autoconf
AUTOHEADER = ${SHELL} '/home/fred/CLionProjects/HDF5_parallel_LZ4/bin/missing' autoheader
AUTOMAKE = ${SHELL} '/home/fred/CLionProjects/HDF5_parallel_LZ4/bin/missing' automake-1.16
AWK = mawk
...
CONFIG_DATE = Mon Apr 14 23:53:07 CEST 2025
CONFIG_MODE = 
CONFIG_USER = fred@frexedo
CPPFLAGS = -g
CSCOPE = cscope
CTAGS = ctags
CXX = no
...
H5_CLASSPATH = 
H5_CPPFLAGS = -D_GNU_SOURCE -D_POSIX_C_SOURCE=200809L   -DNDEBUG -UH5_DEBUG_API -I/home/fred/CLionProjects/HDF5_parallel_LZ4/src/H5FDsubfiling
...
JAVA_JUNIT = 
JAVA_PATH_NAME = 
JAVA_VERSION = /home/fred/.local/bin/ (./configure: line 35416: -version: command not found)
JNIFLAGS = 
JNI_LDFLAGS = 
JUNIT = 
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/fred/CLionProjects/HDF5_parallel_LZ4/bin/missing' makeinfo
MANIFEST_TOOL = :
MAP_API = no
MIRROR_VFD = no
...
PROFILING = no
RANLIB = ranlib
ROOT = /home/fred/CLionProjects/HDF5_parallel_LZ4
ROS3_VFD = no
RUNPARALLEL = 
RUNSERIAL = 
R_INTEGER = 
...
TR = /usr/bin/tr
TRACE_API = no
UNAME_INFO = Linux frexedo 6.11.0-109019-tuxedo #19~24.04.1tux2 SMP PREEMPT_DYNAMIC Mon Feb 17 23:08:54 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
USE_FILE_LOCKING = 
...
WORDS_BIGENDIAN = no
_ACJNI_JAVAC = 
abs_builddir = /home/fred/CLionProjects/HDF5_parallel_LZ4
abs_srcdir = /home/fred/CLionProjects/HDF5_parallel_LZ4
abs_top_builddir = /home/fred/CLionProjects/HDF5_parallel_LZ4
abs_top_srcdir = /home/fred/CLionProjects/HDF5_parallel_LZ4
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/fred/CLionProjects/HDF5_parallel_LZ4/bin/install-sh
...
CHECK_CLEANFILES = *.chkexe *.chklog *-tmp
CXX_DIR = 
...
DIST_SUBDIRS = src test testpar bin tools utils . c++ fortran hl java
...
utils/subfiling_vfd/h5fuse: $(top_builddir)/config.status $(top_srcdir)/utils/subfiling_vfd/h5fuse.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
